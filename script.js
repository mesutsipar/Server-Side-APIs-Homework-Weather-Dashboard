...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=22d5fc104889714d9d130db58ba69731";
    $.ajax({
        url: queryURL,
        method: "GET"
...
function showPrevious() {
    ...
    if (savedLocations) {
        ...
        for(var i=0; i<savedLocations.length;i++){
            var button = $("<button>").addClass("btn btn-primary historyLocation").text(savedLocations[i]);
            $("#prevSearches").append(button);
        }
...
function getCurrent(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=22d5fc104889714d9d130db58ba69731&lat&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET",
        error: function (){
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=22d5fc104889714d9d130db58ba69731&lat=" + response.coord.lat + "&lon=" + response.coord.lat;
        $.ajax({
            url: uvURL,
            method: "GET"
...
function getForecast(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&APPID=22d5fc104889714d9d130db58ba69731&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
